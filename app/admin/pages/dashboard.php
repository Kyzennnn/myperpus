...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di Perpustakaan SMP Negeri 17 Malang.
        </div>
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/LogoSekolah.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">

            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMPN 17 Malang</h2>
            <p class="text-center">Alamat : Jl. Pelabuhan Tanjung Priok No.170, Kec. Sukun, Kota Malang, Jawa Timur</p>
